...
public class Job extends Service {
    ...
    public Job(int id, String email, String name, String description, String adress, Double
            ...
            placesLimit, String salary, String phoneNumber, Boolean ended, String expiresOn) {

        super(id, "Job", email, name, description, adress, positionLat, positionLng,
                phoneNumber, ended, expiresOn);
