...
public class FormularioDonacion extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_formulario_donacion, container, false);
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (result) Toast.makeText(getActivity().getApplicationContext(), "Servicio "
                            + "de donacion creado!", Toast.LENGTH_SHORT).show();
                    else Toast.makeText(getActivity().getApplicationContext(), "Servicio de "
                            + "donacion failed", Toast.LENGTH_SHORT).show();
                } catch (Exception e){
